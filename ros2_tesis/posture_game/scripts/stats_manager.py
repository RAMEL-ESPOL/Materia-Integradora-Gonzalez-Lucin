...
class StatsManager:
    ...
    def save_stats(self, name, score, emotions, total_duration, avg_response_time,
               response_times, response_deviation, total_attempts,
               errors_per_posture, first_error_level, detailed_attempts,
